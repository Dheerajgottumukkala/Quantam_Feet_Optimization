...
"[project]/Desktop/falqon-fleet-optimizer/.next-internal/server/app/api/route-optimization/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/Desktop/falqon-fleet-optimizer/src/app/api/route-optimization/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const pythonOutputPath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'python_output.json');
        console.log('Looking for Python output at:', pythonOutputPath);
        if (!__TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].existsSync(pythonOutputPath)) {
        ...
        const pythonOutput = __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].readFileSync(pythonOutputPath, 'utf8');
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$falqon$2d$fleet$2d$optimizer$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(transformedResults);
    } catch (error) {
        console.error('Error reading route optimization results:', error);
        return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$falqon$2d$fleet$2d$optimizer$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Failed to load route optimization results',
...
function transformPythonResults(pythonResults) {
    ...
    trucks.forEach((truckId, index)=>{
        ...
        const routeSteps = steps.map((step, stepIndex)=>({
                ...
                distance: stepIndex === 0 ? 0 : Math.random() * 20 + 5,
                estimatedTime: stepIndex === 0 ? 0 : Math.random() * 30 + 15,
                loadQuantity: stepIndex === 0 ? 0 : Math.random() * 3 + 1,
                cropType: summary.type === 'Refrigerated' ? 'Milk' : 'Mixed',
                priority: stepIndex === 0 ? 'low' : 'medium',
        ...
        const assignedTrucks = [
            {
                ...
                truckType: summary.type === 'Refrigerated' ? 'Standard' : 'Standard'
            }
        ];
...
//# sourceMappingURL=%5Broot-of-the-server%5D__dbc4e018._.js.map