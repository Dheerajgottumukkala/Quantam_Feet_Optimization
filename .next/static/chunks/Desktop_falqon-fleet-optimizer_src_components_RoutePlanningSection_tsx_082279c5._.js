...
"[project]/Desktop/falqon-fleet-optimizer/src/components/RoutePlanningSection.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$falqon$2d$fleet$2d$optimizer$2f$src$2f$components$2f$ui$2f$textarea$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Desktop/falqon-fleet-optimizer/src/components/ui/textarea.tsx [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$falqon$2d$fleet$2d$optimizer$2f$src$2f$components$2f$ui$2f$separator$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Desktop/falqon-fleet-optimizer/src/components/ui/separator.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$falqon$2d$fleet$2d$optimizer$2f$src$2f$components$2f$ui$2f$checkbox$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Desktop/falqon-fleet-optimizer/src/components/ui/checkbox.tsx [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$falqon$2d$fleet$2d$optimizer$2f$src$2f$lib$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Desktop/falqon-fleet-optimizer/src/lib/config.ts [app-client] (ecmascript)");
;
...
function RoutePlanningSection() {
    _s();
    const [selectedTrucks, setSelectedTrucks] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$falqon$2d$fleet$2d$optimizer$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [availableTrucks, setAvailableTrucks] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$falqon$2d$fleet$2d$optimizer$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [loadingTrucks, setLoadingTrucks] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$falqon$2d$fleet$2d$optimizer$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    const [pickupLocations, setPickupLocations] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$falqon$2d$fleet$2d$optimizer$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([
        {
            id: "1",
            address: "",
            destinationAddress: "",
    ...
    const [optimizedRoute, setOptimizedRoute] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$falqon$2d$fleet$2d$optimizer$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const [showConfirmModal, setShowConfirmModal] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$falqon$2d$fleet$2d$optimizer$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [mapView, setMapView] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$falqon$2d$fleet$2d$optimizer$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("quantum");
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$falqon$2d$fleet$2d$optimizer$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "RoutePlanningSection.useEffect": ()=>{
            const fetchAvailableTrucks = {
                "RoutePlanningSection.useEffect.fetchAvailableTrucks": async ()=>{
                    ...
                    try {
                        ...
                        __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$falqon$2d$fleet$2d$optimizer$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Failed to load available trucks");
                    } finally{
                        setLoadingTrucks(false);
                    }
                }
            }["RoutePlanningSection.useEffect.fetchAvailableTrucks"];
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$falqon$2d$fleet$2d$optimizer$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "RoutePlanningSection.useEffect": ()=>{
            const loadPythonData = {
                "RoutePlanningSection.useEffect.loadPythonData": async ()=>{
                    try {
            ...
            }["RoutePlanningSection.useEffect.loadPythonData"];
            loadPythonData();
        }
    }["RoutePlanningSection.useEffect"], []);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$falqon$2d$fleet$2d$optimizer$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "RoutePlanningSection.useEffect": ()=>{
            const initializeMap = {
                "RoutePlanningSection.useEffect.initializeMap": ()=>{
            ...
            const loadGoogleMaps = {
                "RoutePlanningSection.useEffect.loadGoogleMaps": ()=>{
                    if (window.google) {
                        initializeMap();
                        return;
                    }
    ...
    const totalCapacity = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$falqon$2d$fleet$2d$optimizer$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "RoutePlanningSection.useMemo[totalCapacity]": ()=>{
            return selectedTrucks.reduce({
                "RoutePlanningSection.useMemo[totalCapacity]": (sum, truck)=>sum + truck.capacity
            }["RoutePlanningSection.useMemo[totalCapacity]"], 0);
        }
    }["RoutePlanningSection.useMemo[totalCapacity]"], [
        selectedTrucks
    ]);
    const totalLoad = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$falqon$2d$fleet$2d$optimizer$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "RoutePlanningSection.useMemo[totalLoad]": ()=>{
            return pickupLocations.reduce({
                "RoutePlanningSection.useMemo[totalLoad]": (sum, location)=>sum + location.loadQuantity
            }["RoutePlanningSection.useMemo[totalLoad]"], 0);
        }
    }["RoutePlanningSection.useMemo[totalLoad]"], [
        pickupLocations
    ]);
    const isOverCapacity = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$falqon$2d$fleet$2d$optimizer$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "RoutePlanningSection.useMemo[isOverCapacity]": ()=>{
    ...
    const handleTruckSelection = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$falqon$2d$fleet$2d$optimizer$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "RoutePlanningSection.useCallback[handleTruckSelection]": (truck, isSelected)=>{
            if (isSelected) {
                setSelectedTrucks({
                    "RoutePlanningSection.useCallback[handleTruckSelection]": (prev)=>[
                            ...prev,
                            {
                                id: truck.id,
                ...
                }["RoutePlanningSection.useCallback[handleTruckSelection]"]);
            } else {
                setSelectedTrucks({
                    "RoutePlanningSection.useCallback[handleTruckSelection]": (prev)=>prev.filter({
                            "RoutePlanningSection.useCallback[handleTruckSelection]": (t)=>t.id !== truck.id
                        }["RoutePlanningSection.useCallback[handleTruckSelection]"])
                }["RoutePlanningSection.useCallback[handleTruckSelection]"]);
            }
        }
    }["RoutePlanningSection.useCallback[handleTruckSelection]"], []);
    const addPickupLocation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$falqon$2d$fleet$2d$optimizer$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "RoutePlanningSection.useCallback[addPickupLocation]": ()=>{
            const newLocation = {
            ...
            setPickupLocations({
                "RoutePlanningSection.useCallback[addPickupLocation]": (prev)=>[
                        ...prev,
                        newLocation
                    ]
            }["RoutePlanningSection.useCallback[addPickupLocation]"]);
    ...
    const removePickupLocation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$falqon$2d$fleet$2d$optimizer$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "RoutePlanningSection.useCallback[removePickupLocation]": (id)=>{
            setPickupLocations({
                "RoutePlanningSection.useCallback[removePickupLocation]": (prev)=>prev.filter({
                        "RoutePlanningSection.useCallback[removePickupLocation]": (location)=>location.id !== id
                    }["RoutePlanningSection.useCallback[removePickupLocation]"])
            }["RoutePlanningSection.useCallback[removePickupLocation]"]);
        }
    }["RoutePlanningSection.useCallback[removePickupLocation]"], []);
    const updatePickupLocation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$falqon$2d$fleet$2d$optimizer$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "RoutePlanningSection.useCallback[updatePickupLocation]": (id, updates)=>{
            setPickupLocations({
                "RoutePlanningSection.useCallback[updatePickupLocation]": (prev)=>prev.map({
                        "RoutePlanningSection.useCallback[updatePickupLocation]": (location)=>location.id === id ? {
                                ...location,
                                ...updates
                            } : location
                    }["RoutePlanningSection.useCallback[updatePickupLocation]"])
            }["RoutePlanningSection.useCallback[updatePickupLocation]"]);
        }
    }["RoutePlanningSection.useCallback[updatePickupLocation]"], []);
    const validateForm = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$falqon$2d$fleet$2d$optimizer$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "RoutePlanningSection.useCallback[validateForm]": ()=>{
            ...
            pickupLocations.forEach({
                "RoutePlanningSection.useCallback[validateForm]": (location, index)=>{
                    if (!location.address) {
    ...
    const updateTruckStatusAfterRouteAssignment = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$falqon$2d$fleet$2d$optimizer$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "RoutePlanningSection.useCallback[updateTruckStatusAfterRouteAssignment]": async (truckIds)=>{
            try {
                // Update each truck's availability to "Not Available"
                const updatePromises = truckIds.map({
                    "RoutePlanningSection.useCallback[updateTruckStatusAfterRouteAssignment].updatePromises": (truckId)=>fetch(`/api/trucks?id=${truckId}`, {
                            method: 'PUT',
                            headers: {
                ...
                }["RoutePlanningSection.useCallback[updateTruckStatusAfterRouteAssignment].updatePromises"]);
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$falqon$2d$fleet$2d$optimizer$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(`${truckIds.length} truck(s) status updated to "Not Available"`);
            } catch (err) {
                __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$falqon$2d$fleet$2d$optimizer$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Failed to update truck status");
            }
        }
    }["RoutePlanningSection.useCallback[updateTruckStatusAfterRouteAssignment]"], []);
    const saveRouteToDatabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$falqon$2d$fleet$2d$optimizer$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "RoutePlanningSection.useCallback[saveRouteToDatabase]": async (routeData)=>{
            try {
                // Create route
                ...
                const routeTruckPromises = routeData.assignedTrucks.map({
                    "RoutePlanningSection.useCallback[saveRouteToDatabase].routeTruckPromises": (truck)=>fetch('/api/route-trucks', {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json'
                            },
                ...
                }["RoutePlanningSection.useCallback[saveRouteToDatabase].routeTruckPromises"]);
                await Promise.all(routeTruckPromises);
                // Create pickup locations
                const pickupLocationPromises = routeData.steps.map({
                    "RoutePlanningSection.useCallback[saveRouteToDatabase].pickupLocationPromises": (step, index)=>fetch('/api/pickup-locations', {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json'
                            },
                ...
                }["RoutePlanningSection.useCallback[saveRouteToDatabase].pickupLocationPromises"]);
                await Promise.all(pickupLocationPromises);
                __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$falqon$2d$fleet$2d$optimizer$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Route saved to database successfully!");
                return routeId;
            } catch (err) {
                __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$falqon$2d$fleet$2d$optimizer$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Failed to save route to database");
                throw err;
            }
        }
    }["RoutePlanningSection.useCallback[saveRouteToDatabase]"], [
        totalLoad
    ]);
    const handleOptimizeRoute = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$falqon$2d$fleet$2d$optimizer$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "RoutePlanningSection.useCallback[handleOptimizeRoute]": async ()=>{
            if (!validateForm()) return;
            setIsLoading(true);
            setShowConfirmModal(false);
            try {
                // Show initial progress
                __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$falqon$2d$fleet$2d$optimizer$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].loading("Initializing quantum optimizer...", {
                    id: "route-optimization"
                });
                await new Promise({
                    "RoutePlanningSection.useCallback[handleOptimizeRoute]": (resolve)=>setTimeout(resolve, 1000)
                }["RoutePlanningSection.useCallback[handleOptimizeRoute]"]);
                __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$falqon$2d$fleet$2d$optimizer$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].loading("Computing optimal path for multiple trucks...", {
                    id: "route-optimization"
                });
                await new Promise({
                    "RoutePlanningSection.useCallback[handleOptimizeRoute]": (resolve)=>setTimeout(resolve, 2000)
                }["RoutePlanningSection.useCallback[handleOptimizeRoute]"]);
                ...
                await updateTruckStatusAfterRouteAssignment(selectedTrucks.map({
                    "RoutePlanningSection.useCallback[handleOptimizeRoute]": (t)=>t.id
                }["RoutePlanningSection.useCallback[handleOptimizeRoute]"]));
                const computeTime = Math.round((Date.now() - Date.now()) / 1000) + 3;
                __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$falqon$2d$fleet$2d$optimizer$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(`Route optimized for ${optimizedRoute.assignedTrucks.length} truck(s) in ${computeTime}s using quantum computing`, {
                    id: "route-optimization"
                });
            } catch (error) {
                console.error("Route optimization error:", error);
                // Fallback to mock data if Python results are not available
                __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$falqon$2d$fleet$2d$optimizer$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].loading("Falling back to classical optimization...", {
                    id: "route-optimization"
                });
                const mockRoute = {
                    id: Date.now().toString(),
                    assignedTrucks: selectedTrucks,
                    steps: pickupLocations.map({
                        "RoutePlanningSection.useCallback[handleOptimizeRoute]": (location, index)=>({
                                id: location.id,
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$falqon$2d$fleet$2d$optimizer$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(`Route optimized for ${selectedTrucks.length} truck(s) using classical algorithms (Python results unavailable)`, {
                    id: "route-optimization"
                });
            } finally{
                setIsLoading(false);
    ...
    const handleSaveRoute = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$falqon$2d$fleet$2d$optimizer$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "RoutePlanningSection.useCallback[handleSaveRoute]": async ()=>{
            if (!optimizedRoute) return;
            try {
                __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$falqon$2d$fleet$2d$optimizer$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].loading("Saving route...", {
                    id: "save-route"
                });
                // Route is already saved during optimization, so just confirm
                await new Promise({
                    "RoutePlanningSection.useCallback[handleSaveRoute]": (resolve)=>setTimeout(resolve, 1000)
                }["RoutePlanningSection.useCallback[handleSaveRoute]"]);
                __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$falqon$2d$fleet$2d$optimizer$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Route saved successfully!", {
                    id: "save-route"
                });
            } catch (error) {
                __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$falqon$2d$fleet$2d$optimizer$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Failed to save route", {
                    id: "save-route"
                });
            }
        }
    ...
    const handleExportRoute = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$falqon$2d$fleet$2d$optimizer$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "RoutePlanningSection.useCallback[handleExportRoute]": async (format)=>{
            if (!optimizedRoute) return;
            try {
                __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$falqon$2d$fleet$2d$optimizer$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].loading(`Exporting route as ${format.toUpperCase()}...`, {
                    id: "export-route"
                });
                if (format === "csv") {
                    ...
                    const rows = optimizedRoute.steps.map({
                        "RoutePlanningSection.useCallback[handleExportRoute].rows": (step, index)=>[
                                index + 1,
                                step.address,
                                step.cropType,
                                step.loadQuantity,
                    ...
                    }["RoutePlanningSection.useCallback[handleExportRoute].rows"]);
                    const csvContent = [
                        headers,
                        ...rows
                    ].map({
                        "RoutePlanningSection.useCallback[handleExportRoute].csvContent": (row)=>row.join(",")
                    }["RoutePlanningSection.useCallback[handleExportRoute].csvContent"]).join("\n");
                    // Download CSV
                    const blob = new Blob([
                        csvContent
                    ], {
                    ...
                    // Simulate PDF export
                    await new Promise({
                        "RoutePlanningSection.useCallback[handleExportRoute]": (resolve)=>setTimeout(resolve, 1000)
                    }["RoutePlanningSection.useCallback[handleExportRoute]"]);
                }
                __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$falqon$2d$fleet$2d$optimizer$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(`Route exported as ${format.toUpperCase()}!`, {
                    id: "export-route"
                });
            } catch (error) {
                __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$falqon$2d$fleet$2d$optimizer$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Failed to export route", {
                    id: "export-route"
                });
            }
        }
...
//# sourceMappingURL=Desktop_falqon-fleet-optimizer_src_components_RoutePlanningSection_tsx_082279c5._.js.map